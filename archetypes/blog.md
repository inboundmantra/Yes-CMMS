...
date: {{ .Date }}
draft: false
summary: Type your subtitle here - the summary that would appear on blog cards - and if you don't, first 21 words from the content will be picked as summary
...
alt: Alt text for main blog image
